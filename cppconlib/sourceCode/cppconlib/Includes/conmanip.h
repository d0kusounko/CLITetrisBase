...
namespace conmanip
{
   ...
   static inline console_modes operator&(console_modes const a, console_modes const b)
   {
   ...
   static inline console_cleanup_options operator&(console_cleanup_options const a, console_cleanup_options const b)
   {
   ...
   namespace _details
   {
	   static inline void _settextcolor(HANDLE const console, console_text_colors const color)
      {
	  ...
	  static inline void _setbgcolor(HANDLE const console, console_bg_colors const color)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
	  ...
	  static inline void _setcolors(HANDLE const console, console_colors const color)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
	  ...
	  static inline void _setmode(HANDLE const console, console_modes const modes)
      {
         DWORD mode = 0;
	  ...
	  static inline void _clearmode(HANDLE const console, console_modes const modes)
      {
         DWORD mode = 0;
         ::GetConsoleMode(console, &mode);
	  ...
	  static inline int _getposx(HANDLE const console)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
	  ...
	  static inline void _setposx(HANDLE const console, int const x)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
	  ...
	  static inline int _getposy(HANDLE const console)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
	  ...
	  static inline void _setposy(HANDLE const console, int const y)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
      ...
      static inline COORD _getpos(HANDLE const console)
      {
         CONSOLE_SCREEN_BUFFER_INFO info;
         ::GetConsoleScreenBufferInfo(console, &info);
	  ...
	  static inline void _setpos(HANDLE const console, COORD const pos)
      {
   ...
   static inline console_manipulator<console_text_colors> settextcolor(console_text_colors const color)
   {	
   ...
   static inline console_manipulator<console_bg_colors> setbgcolor(console_bg_colors const color)
   {	
   ...
   static inline console_manipulator<console_colors> setcolors(console_text_colors const text, console_bg_colors const background)
   {	
   ...
   static inline console_manipulator<console_modes> setmode(console_modes const modes)
   {	
   ...
   static inline console_manipulator<console_modes> clearmode(console_modes const modes)
   {	
   ...
   static inline console_manipulator<int> setposx(int const x)
   {	
   ...
   static inline console_manipulator<int> setposy(int const y)
   {	
   ...
   static inline console_manipulator<COORD> setpos(int const x, int const y)
   {	
